<?php if (!is_page_template('blank-page-template.php')) {
    if (!get_theme_mod('extensoes_da_nova_footer_visibility')) { ?>

        <footer id="footer" class="<?php if (get_theme_mod('extensoes_da_nova_navbar_color') == "light") {
                                        echo "";
                                    } else {
            ...
            <div class="container <?php if (get_theme_mod('extensoes_da_nova_navbar_color') == "light") {
                                        echo "border-top";
                                    } else {
                                        echo "";
                                    }
                ...
                <div class="row text-center py-5">
                    ...
                    <div class="col-12 col-sm-6 text-sm-end contact">
                        ...
                        <?php
                        // check to see if the logo exists and add it to the page
                        if (get_theme_mod('extensoes_da_nova_footer_info')) : ?>

                            <?php echo get_theme_mod('extensoes_da_nova_footer_info'); ?>
